...
void handleIndex() {
  ...
  content +="<tr>";
  content +="<td></td>";
  content +="<td><button  class=\"pm_btn\" type=\"button\" onclick=\"action(9)\">Backward</button></td>";
  content +="<td></td>";
  content +="</tr>";
  content +="</table>";
...
void handlerEditor(){
  ...
  content += "<td width=\"50%\">GPID14<br/><input class=\"pm_text\" type=\"text\" id=\"gpid_14\" value=\"0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlGpid(17, 'gpid_14')\">SEND</button></td>";
  content += "<td width=\"50%\">GPID12<br/><input class=\"pm_text\" type=\"text\" id=\"gpid_12\"  value=\"0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlGpid(16, 'gpid_12')\">SEND</button></td>";
  content += "</tr>";
  
  content += "<tr>";
  content += "<td>Servo8<br/><input class=\"pm_text\" type=\"text\" id=\"servo_8\" value=\"0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(8,'servo_8')\">SEND</button></td>";
  content += "<td>Servo7<br/><input class=\"pm_text\" type=\"text\" id=\"servo_7\" value=\"0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(7, 'servo_7')\">SEND</button></td>";
  content += "</tr>";
  
  content += "<tr>";
  content += "<td>Servo9<br/><input class=\"pm_text\" type=\"text\" id=\"servo_9\" value=\"0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(9,'servo_9')\">SEND</button></td>";
  content += "<td>Servo6<br/><input class=\"pm_text\" type=\"text\" id=\"servo_6\" value=\"0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(6,'servo_6')\">SEND</button></td>";
  content += "</tr>";
  
  content += "<tr>";
  content += "<td>Servo10<br/><input class=\"pm_text\" type=\"text\" id=\"servo_10\" value=\"0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(10,'servo_10')\">SEND</button></td>";
  content += "<td>Servo5<br/><input class=\"pm_text\" type=\"text\" id=\"servo_5\" value=\"0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(5,'servo_5')\">SEND</button></td>";
  content += "</tr>";
  
  content += "<tr>";
  content += "<td>Servo11<br/><input class=\"pm_text\" type=\"text\" id=\"servo_11\" value=\"0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(11,'servo_11')\">SEND</button></td>";
  content += "<td>Servo4<br/><input class=\"pm_text\" type=\"text\" id=\"servo_4\" value=\"0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(4,'servo_4')\">SEND</button></td>";
  content += "</tr>";
  
  
  content += "<tr>";
  content += "<td>Servo12<br/><input class=\"pm_text\" type=\"text\" value=\"0\" id=\"servo_12\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(12,'servo_12')\">SEND</button></td>";
  content += "<td>Servo3<br/><input class=\"pm_text\" type=\"text\" value=\"0\" id=\"servo_3\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(3,'servo_3')\">SEND</button></td>";
  content += "</tr>";
  
  
  content += "<tr>";
  content += "<td>Servo13<br/><input class=\"pm_text\" type=\"text\" value=\"0\" id=\"servo_13\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(13,'servo_13')\">SEND</button></td>";
  content += "<td>Servo2<br/><input class=\"pm_text\" type=\"text\" value=\"0\" id=\"servo_2\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(2,'servo_2')\">SEND</button></td>";
  content += "</tr>";
  
  
  content += "<tr>";
  content += "<td>Servo14<br/><input class=\"pm_text\" type=\"text\" value=\"0\" id=\"servo_14\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(14,'servo_14')\">SEND</button></td>";
  content += "<td>Servo1<br/><input class=\"pm_text\" type=\"text\" value=\"0\" id=\"servo_1\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(1,'servo_1')\">SEND</button></td>";
  content += "</tr>";
  
  content += "<tr>";
  content += "<td>Servo15<br/><input class=\"pm_text\" type=\"text\" value=\"0\" id=\"servo_15\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(15,'servo_15')\">SEND</button></td>";
  content += "<td>Servo0<br/><input class=\"pm_text\" type=\"text\" value=\"0\" id=\"servo_0\"><button class=\"pm_btn\" type=\"button\" onclick=\"controlServo(0,'servo_0')\">SEND</button></td>";
  content += "</tr>";
...
void handleSetting()
{
  ...
  server.send(200, "text/html", content);//顯示讀取的網頁
}
...
void handleSave()
{
  ...
  else
  {
    ...
    if(keyInt==16){
      ...
      //SERVOMIN = 1100
      //SERVOMAX = 2700
      int pulselength = map(pwnVal, PWMRES_Min, PWMRES_Max, SERVOMIN, SERVOMAX);
...
void handleMotor(){
  ...
  if(motorId!="" && value!=""){
    ...
    if(iMotorId==16){
      int GPIO12_PWM = actionDavinci[16] + iServoPWM + readKeyValue(16); 
      GPIO12SERVO.write(GPIO12_PWM);
    }
    else if(iMotorId==17){
      int GPIO14_PWM = actionDavinci[17] + iServoPWM + readKeyValue(17);
      GPIO14SERVO.write(GPIO14_PWM);
    }
    else{
      int SERVOID_PWM = actionDavinci[iMotorId] + iServoPWM + readKeyValue(iMotorId);
      //PWMRES_Min, PWMRES_Max
      int pulselength = map(SERVOID_PWM, PWMRES_Min, PWMRES_Max, SERVOMIN, SERVOMAX);
      //int pulselength = map(SERVOID_PWM, 0, 180, SERVOMIN, SERVOMAX);
...
void handleFight(){
  ...
  server.send(200, "text/html", "fight=complete");
}
...
void enableWebServer(){
  ...
  server.on("/fight", getMethod, handleFight);
  
  server.on("/action", getMethod, handleAction);//指定動作
  server.on("/save", getMethod, handleSave);
  server.on("/motor", getMethod, handleMotor);//設定校正值
  server.on("/reset", getMethod, handleReset);
  
  server.on("/hello_action",getMethod, handleHelloAction);
  
  server.on("/davinci",getMethod, resetToDavinci);
  server.on("/stand",getMethod, resetToStand);
  server.on("/fight",getMethod, resetToFight);
